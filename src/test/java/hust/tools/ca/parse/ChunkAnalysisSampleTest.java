...
public class ChunkAnalysisSampleTest {
	...
	public void testGetWords() {
		assertArrayEquals(sample1.getWords(), words1);
		assertArrayEquals(sample2.getWords(), words2);
		assertArrayEquals(sample3.getWords(), words3);
	}
	
	@Test
	public void testGetPoses() {
		assertArrayEquals(sample1.getPoses(), poses1);
		assertArrayEquals(sample2.getPoses(), poses2);
		assertArrayEquals(sample3.getPoses(), poses3);
	}
	
	@Test
	public void testGetTags() {
		assertArrayEquals(sample1.getChunkTags(), tags1);
		assertArrayEquals(sample2.getChunkTags(), tags2);
		assertArrayEquals(sample3.getChunkTags(), tags3);
	}
}
