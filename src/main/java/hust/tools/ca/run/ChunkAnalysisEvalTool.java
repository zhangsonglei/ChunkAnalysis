...
public class ChunkAnalysisEvalTool {
	 ...
	 * @throws IOException
	 */
    public static void evalBasedWordAndPOS(File trainFile, TrainingParameters params, File goldFile, String encoding, File errorFile) throws IOException {
	 ...
	 * @throws IOException
	 */
    public static void evalBasedWord(File trainFile, TrainingParameters params, File goldFile, String encoding, File errorFile) throws IOException {
        System.out.println("训练模型...");  
        ObjectStream<String> lineStream = new PlainTextByLineStream(new MarkableFileInputStreamFactory(trainFile), encoding);
    ...
    public static void main(String[] args) throws IOException, InstantiationException, IllegalAccessException, ClassNotFoundException  {
        ...
        if(method.equals("w")) {
        	if (errorFile != null)
        		evalBasedWord(new File(modelFile), params, new File(goldFile), encoding, new File(errorFile));
        	else
        		evalBasedWord(new File(modelFile), params, new File(goldFile), encoding, null);
        }else if(method.equals("wp")){
        	if (errorFile != null)
        		evalBasedWordAndPOS(new File(modelFile), params, new File(goldFile), encoding, new File(errorFile));
        	else
        		evalBasedWordAndPOS(new File(modelFile), params, new File(goldFile), encoding, null);
        }else{
