...
/**
 *<ul>
 *<li>Description: BIEO序列验证类,验证当前组块标记是否合法
 *<li>Company: HUST
 *<li>@author Sonly
 *<li>Date: 2017年12月6日
 *</ul>
 */
public class ChunkAnalysisSequenceValidatorWithBIEO implements SequenceValidator<String> {
		
	public ChunkAnalysisSequenceValidatorWithBIEO() {
