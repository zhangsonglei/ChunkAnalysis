 ...
 *</ul>
 */
public class ChunkAnalysisBasedWordContextGenratorConf implements ChunkAnalysisBasedWordContextGenerator {
	 ...
	 * @throws IOException
	 */
	public ChunkAnalysisBasedWordContextGenratorConf() throws IOException {
		Properties featureConf = new Properties();
        InputStream featureStream = ChunkAnalysisBasedWordContextGenratorConf.class.getClassLoader().getResourceAsStream("properties/feature.properties");
	 ...
	 */
	public ChunkAnalysisBasedWordContextGenratorConf(Properties properties){
        init(properties);
	}
