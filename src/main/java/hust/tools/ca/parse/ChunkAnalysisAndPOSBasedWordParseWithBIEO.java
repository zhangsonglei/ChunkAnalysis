 ...
 *</ul>
 */
public class ChunkAnalysisAndPOSBasedWordParseWithBIEO extends AbstractChunkAnalysisParse {
	
	private final String ChunkBegin = "_B";	//当前词在组块开始
	private final String InChunk = "_I";	//当前词在组块中
	private final String OutChunk = "O";	//当前词非组块
	private final String ChunkEnd = "_E";	//当前词在组块结束
	 ...
	 * 构造方法
	 */
	public ChunkAnalysisAndPOSBasedWordParseWithBIEO() {
