...
/**
 *<ul>
 *<li>Description: 基于词组块分析的BIEO样本解析（组块最小长度为1）
 *<li>Company: HUST
 *<li>@author Sonly
 *<li>Date: 2017年12月3日
 *</ul>
 */
public class ChunkAnalysisBasedWordParseWithBIEOS extends AbstractChunkAnalysisParse {
	 ...
	 * 构造方法
	 */
	public ChunkAnalysisBasedWordParseWithBIEOS() {
