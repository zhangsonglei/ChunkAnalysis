...
/**
 *<ul>
 *<li>Description: 基于词的词性标注和组块分析模型 
 *<li>Company: HUST
 *<li>@author Sonly
 *<li>Date: 2017年12月3日
 *</ul>
 */
public class ChunkAnalysisAndPOSBasedWordModel extends BaseModel {
	
	/**
	 * 训练模型的类
	 */
	private static final String COMPONENT_NAME = "ChunkAnalysisAndPOSBasedWordME";
	
	/**
	 * 
	 */
	private static final String CHUNK_MODEL_ENTRY_NAME = "ChunkAnalysisAndPOSBasedWord.model";
	 ...
	 */
	protected ChunkAnalysisAndPOSBasedWordModel(String componentName, File modelFile) throws IOException {
		super(COMPONENT_NAME, modelFile);
	}
	
	public ChunkAnalysisAndPOSBasedWordModel(File modelFile) throws IOException {
		super(COMPONENT_NAME, modelFile);
	}
	 ...
	 */
	public ChunkAnalysisAndPOSBasedWordModel(String encoding, MaxentModel maxentModel, int beamSize,
	 ...
	 */
	public ChunkAnalysisAndPOSBasedWordModel(String encoding, ChunkAnalysisSequenceClassificationModel<String> chunkClasssificationModel,
			Map<String, String> manifestInfoEntries) {
		super(COMPONENT_NAME, encoding, manifestInfoEntries, null);
