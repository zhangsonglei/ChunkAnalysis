 ...
 *</ul>
 */
public class ChunkAnalysisBasedWordAndPOSErrorPrinter extends ChunkAnalysisBasedWordAndPOSEvaluateMonitor {
	 ...
	 * @param out	输出流
	 */
	public ChunkAnalysisBasedWordAndPOSErrorPrinter(OutputStream out){
